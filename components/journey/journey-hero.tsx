      ...
      <div className="relative min-h-[60vh] flex items-center" ref={heroRef}>
        ...
        <div className="container mx-auto px-4 z-20 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Our{" "}
              <span className="bg-gradient-to-r from-red-400 to-red-500 bg-clip-text text-transparent">Journey</span>
            </motion.h1>
            ...
            >
              A decade of innovation and excellence in market research
            </motion.p>
          </div>
        </div>
      </div>
