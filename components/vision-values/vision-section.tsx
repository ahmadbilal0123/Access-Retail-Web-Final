...
export default function VisionSection() {
    ...
    <>
      ...
      <section className=" py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 relative z-10">
        <div className="container mx-auto max-w-3xl">
          ...
          {/* Icon and paragraph - RESPONSIVE LAYOUT */}
          <div className="flex flex-col sm:flex-row items-center sm:items-center gap-6 mb-8" ref={ref}>
            {/* Circle icon - centered on mobile, left on desktop */}
            <motion.div
            ...
            >
             <p className="text-white text-base sm:text-lg leading-relaxed text-center sm:text-left mx-auto sm:ml-20 w-fit">
  Visualisation of our client relationships
          ...
          <motion.div
            ...
            className="bg-[#1a2d3d]/90 backdrop-blur-sm rounded-lg p-4 sm:p-6 md:p-8 max-w-2xl mx-auto relative overflow-hidden"
          >
            {/* Animated gradient for the card */}
            <motion.div
              className="absolute inset-0 opacity-20 bg-gradient-to-br from-blue-500/20 via-transparent to-red-500/20"
              animate={{
                background: [
                  "linear-gradient(to bottom right, rgba(59, 130, 246, 0.2), transparent, rgba(239, 68, 68, 0.2))",
                  "linear-gradient(to bottom left, rgba(59, 130, 246, 0.2), transparent, rgba(239, 68, 68, 0.2))",
                  "linear-gradient(to top right, rgba(59, 130, 246, 0.2), transparent, rgba(239, 68, 68, 0.2))",
                  "linear-gradient(to bottom right, rgba(59, 130, 246, 0.2), transparent, rgba(239, 68, 68, 0.2))",
                ],
              }}
      ...
      <section className=" py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 border-t border-blue-900/30 relative z-10">
        <div className="container mx-auto max-w-3xl">
          ...
          {/* Icon and paragraph - RESPONSIVE LAYOUT */}
          <div className="flex flex-col sm:flex-row items-center sm:items-center gap-6 mb-8" ref={valuesRef}>
            {/* Circle icon - centered on mobile, left on desktop */}
            <motion.div
              initial={{ opacity: 0, x: -20 }}
            ...
            <motion.div
              initial={{ opacity: 0, y: 20, x: 0 }}
              animate={valuesInView ? { opacity: 1, y: 0, x: 0 } : { opacity: 0, y: 20, x: 0 }}
              transition={{ duration: 0.7, delay: 0.2 }}
              className="text-center sm:text-left"
            >
